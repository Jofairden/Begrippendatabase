          ...
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 500px;"><tr class="layout-full-width" style="background-color:transparent;"><![endif]-->
            ...
            <div class="col num12" style="min-width: 320px;max-width: 500px;width: 500px;width: calc(18000% - 89500px);background-color: transparent;">
              ...
              <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                    ...
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
<div style="color:#555555;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
	<div><p style="margin: 0;font-size: 12px;line-height: 14px">We willen je graag laten weten dat je suggestie voor de Begrippen database helaas niet is geaccepteerd..</p><p style="margin: 0;font-size: 12px;line-height: 14px"><br data-mce-bogus="1"></p><p style="margin: 0;font-size: 12px;line-height: 14px">Reden:</p><p style="margin: 0;font-size: 12px;line-height: 14px"><span style="font-size: 12px; line-height: 14px;" id="autocomplete"><span style="font-size: 12px; line-height: 14px;" id="autocomplete-delimiter"></span><span style="font-size: 12px; line-height: 14px;" id="autocomplete-searchtext"><span class="dummy" style="font-size: 12px; line-height: 14px;">{{ $reason }}</span></span></span></p></div>	
</div>
<!--[if mso]></td></tr></table><![endif]-->
